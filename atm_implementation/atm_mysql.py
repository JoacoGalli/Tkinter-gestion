...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.controller.title('Gestion de Campos')
...
def register():
  ...
  screen1.iconphoto(False,tk.PhotoImage(file='images/abc.png'))
...
def main_screen():
  ...
  screen.title("Gestion de campos")
  screen.configure(bg='lightblue')
  screen.iconphoto(False,tk.PhotoImage(file='images/abc.png'))


  Label(text = "Gestion de campos",fg='white', bg = "grey", width = "300", height = "2", font = ("orbitron", 15,'bold')).pack()
